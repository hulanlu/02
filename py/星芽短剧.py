...
class Spider(Spider):
    ...
    def homeContent(self, filter):
        result = {}
        result = {"class": [{"type_id": "1", "type_name": "澜露🌠剧场"},
                            {"type_id": "3", "type_name": "澜露🌠新剧"},
                            {"type_id": "2", "type_name": "澜露🌠热播"},
                            {"type_id": "7", "type_name": "澜露🌠星选"},
                            {"type_id": "5", "type_name": "澜露🌠阳光"}],
                  }
    ...
    def detailContent(self, ids):
        ...
        content = '澜露🎉为您介绍剧情📢' + data['data']['introduction']
