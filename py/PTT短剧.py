...
class Spider(Spider):
    ...
    def homeContent(self, filter):
        result = {}
        result = {"class": [{"type_id": "67", "type_name": "澜露🌠爽剧"},
                            {"type_id": "68", "type_name": "澜露🌠言情"},
                            {"type_id": "70", "type_name": "澜露🌠穿越"},
                            {"type_id": "71", "type_name": "澜露🌠悬疑"},
                            {"type_id": "73", "type_name": "澜露🌠古装"},
                            {"type_id": "80", "type_name": "澜露🌠都市"},
                            {"type_id": "84", "type_name": "澜露🌠甜宠"},
                            {"type_id": "85", "type_name": "澜露🌠恋爱"},
                            {"type_id": "74", "type_name": "澜露🌠其他"}],
    ...
    def detailContent(self, ids):
        ...
        content = '澜露🎉为您介绍剧情📢' + self.extract_middle_text(res,'劇情介紹</h3>','</p>', 0)
