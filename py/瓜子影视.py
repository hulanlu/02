...
class Spider(Spider):
    ...
    def homeContent(self, filter):
        result = {}
        result = {"class": [{"type_id": "1", "type_name": "澜露🌠电影"},
                            {"type_id": "2", "type_name": "澜露🌠剧集"},
                            {"type_id": "3", "type_name": "澜露🌠综艺"},
                            {"type_id": "4", "type_name": "澜露🌠动漫"},
                            {"type_id": "64", "type_name": "澜露🌠短剧"}],
                  "list": [],
                  "filters": {"1": [{"key": "地区",
                                    "name": "地区",
                                    "value": [{"n": "全部", "v": "0"},
    ...
    def build_vod_content(self, data):
        ...
        if raw_content:
            return f"😸澜露为您介绍剧情📢{raw_content}"
        return "😸澜露为您介绍剧情📢暂无剧情介绍"
